...
- (void)viewDidLoad {
 ...
 // self.navigationItem.title = KKPasscodeLockLocalizedString(@"Passcode Lock", @"");
    ...
    titleLabel.text = KKPasscodeLockLocalizedString(@"Passcode Lock", @"");  //设置标题
    
    titleLabel.textColor = [UIColor colorWithRed:74/255 green:40/255 blue:41/255 alpha:1];
  ...
  [_eraseDataSwitch addTarget:self action:@selector(eraseDataSwitchChanged:) forControlEvents:UIControlEventValueChanged];
    ...
    self.tableView.backgroundColor = [UIColor colorWithRed:0.24 green:0.24 blue:0.24 alpha:1];
...
//    cell.textLabel.textColor = CustomBlueColor;
