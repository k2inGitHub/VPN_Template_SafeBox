...
//                                                                                              action:@selector(cancelButtonPressed:)];
    ...
    //kt
    self.navigationItem.title = NSLocalizedString(@"SafeBox", @"SafeBox");
...
- (void)incrementFailedAttemptsLabel
{
    ...
    _failedAttemptsLabel.numberOfLines = 0;
    //kt
...
- (UIView*)headerViewForTextField:(UITextField*)textField
{
	...
	UILabel *headerLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0, self.isSmallLandscape ? 2.0f : 44, self.view.bounds.size.width, 30.0)];
