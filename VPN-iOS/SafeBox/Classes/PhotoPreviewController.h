...
@interface PhotoPreviewController : KTViewController<UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIAlertViewDelegate, UIActionSheetDelegate, PhotoMoveControllerDelegate>
...
@property (nonatomic, assign) id<PhotoPreviewControllerDelegate> delegate;
